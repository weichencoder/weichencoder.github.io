...
APV的主要缺点是它无法衡量风险因素，因为它仅汇总所有定期收益，而没有考虑这些收益的波动。 第二个指标是夏普比率（SR）([^Sharpe, 1964]; [^Sharpe, 1994])，用于考虑风险。 该比率是经过风险调整的平均收益率，定义为无风险收益率的平均值，由其偏差表示，
$$
